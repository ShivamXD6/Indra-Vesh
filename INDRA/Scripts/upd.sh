...
Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/INDRA/Scripts/upd.sh" "$SRT/upd.sh"
indc "${G} Updated Updater Menu
 ${Y} Version: "$(READ "UPDA-V" "$OLDUPC")" -> "$(READ "UPDA-V" "$UPC")" ${N}"
UPV="$(READ "UPDA-V" "$UPC")"
SET "UPDA-V" "$UPV" "$OLDUPC"
indc "${C} Restarting Updater for Applying changes ${N}"
sleep 4
mv "$CONF/old-upc.txt" "$CONF/upc.txt"
sh "$DB/mod-util.sh"
. "$SRT/upd.sh"
...
if [ "$(READ "CORE-V" "$UPC")" -gt "$(READ "CORE-V" "$OLDUPC")" ]; then
    Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/service.sh" "$MODPATH/service.sh"
    Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/post-fs-data.sh" "$MODPATH/post-fs-data.sh"
    Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/system.prop" "$MODPATH/system.prop"
    Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/system/bin/indra" "$MODPATH/system/bin/indra"
...
if [ "$(READ "MENU-V" "$UPC")" -gt "$(READ "MENU-V" "$OLDUPC")" ]; then
    Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/INDRA/indra.sh" "$DB/indra.sh"
    Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/INDRA/mod-util.sh" "$DB/mod-util.sh"
...
if [ "$(READ "TOGG-V" "$UPC")" -gt "$(READ "TOGG-V" "$OLDUPC")" ]; then
    Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/INDRA/Configs/blc.txt" "$CONF/blc.txt"
    Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/INDRA/Scripts/bls.sh" "$SRT/bls.sh"
...
if [ "$(READ "TUNE-V" "$UPC")" -gt "$(READ "TUNE-V" "$OLDUPC")" ]; then
    Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/INDRA/Configs/cfc.txt" "$CONF/cfc.txt"
    Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/INDRA/Scripts/cfs.sh" "$SRT/cfs.sh"
...
Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/INDRA/Scripts/mks.sh" "$SRT/mks.sh"
...
Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/INDRA/Configs/cfgc.txt" "$CONF/cfgc.txt"
Download "https://raw.githubusercontent.com/ShivamXD6/Indra-Vesh/main/INDRA/Scripts/cfgs.sh" "$SRT/cfgs.sh"
